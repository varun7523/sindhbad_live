        ...
        <div class="card card-primary">
          ...
          <form name="banner_form" id="banner_form" method="post" enctype="multipart/form-data" action="store">
            ...
            <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputBannerUrl">Redirection URL*</label>
                  <input type="text" class="form-control required_field" name="button_link" id="button_link" autocomplete="off" value="@if(isset($bannerDetails['button_link']) && !empty($bannerDetails['button_link'])) {{$bannerDetails['button_link']}} @endif" placeholder="Enter Url">
                  <span class="invalid-feedback" role="alert">
                    <strong id="button_link-error"></strong>
                  </span>
                </div>
              </div>
              <div class="row">
